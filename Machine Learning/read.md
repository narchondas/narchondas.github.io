...
Proposed Business Analytic Question:
...
Every additional review results in the price dropping by $0.12 on average.

P value suggests significant impact.
Reviews per month
...
Each additional review decreases the price by $0.07.
...
$41.53 more expensive than the baseline.
...
Listings are $99.87 more expensive that the baseline reference
...
Queens listing are 16.44$ more expensive
 
But have a weaker impact
...
Does not significantly impact price
(p > 0.05)
